    ...
    public function render($pdf, $preview, $user) {
        ...
        if ($preview) {
            ...
            if ($dateitem == CUSTOMCERT_DATE_ISSUE) {
                ...
                // T14g - Coloca a data de inclusão do aluno no lugar da data de início do curso
                $inicio = $DB->get_record('user_enrolments', array('userid' => $user->id), 'timecreated');
                // T14g - Formatação da string 
                $unix_time = substr(json_encode($inicio), 16 ,-2);
                $date = $unix_time;
                //T14g- Testes
                // T14g - Formata a data 
